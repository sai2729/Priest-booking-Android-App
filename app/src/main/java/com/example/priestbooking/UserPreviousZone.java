...
public class UserPreviousZone {

    private String uname,umobile,ulocation,timings,reqservice,price;

    public UserPreviousZone(String uname, String umobile, String ulocation, String timings, String reqservice, String price){
        this.uname=uname;
